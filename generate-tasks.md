...
To guide an AI assistant in creating a detailed, step-by-step task list in Markdown format based on user requirements, feature requests, or existing documentation. The task list should guide a developer through implementation using a Test-Driven Development (TDD) approach.
...
5.  **Phase 2: Generate Sub-Tasks:** Once the user confirms, break down each parent task into smaller, actionable sub-tasks necessary to complete the parent task following a TDD flow. Ensure sub-tasks logically follow from the parent task and cover the implementation details implied by the requirements.
    *   For each piece of functionality identified:
        *   Generate a sub-task to **write a unit test**.
        *   Generate a sub-task to **implement the code** that makes the test pass.
        *   Generate a sub-task to **run the unit test** to verify the implementation.
...
- [ ] 1.0 Parent Task Title
  - [ ] 1.1 **Test:** Write unit test for [sub-task description 1.1]
  - [ ] 1.1 **Implement:** [sub-task description 1.1]
  - [ ] 1.1 **Verify:** Run unit test for [sub-task description 1.1]
  - [ ] 1.2 **Test:** Write unit test for [sub-task description 1.2]
  - [ ] 1.2 **Implement:** [sub-task description 1.2]
  - [ ] 1.2 **Verify:** Run unit test for [sub-task description 1.2]
- [ ] 2.0 Parent Task Title
  - [ ] 2.1 **Test:** Write unit test for [sub-task description 2.1]
  - [ ] 2.1 **Implement:** [sub-task description 2.1]
  - [ ] 2.1 **Verify:** Run unit test for [sub-task description 2.1]
- [ ] 3.0 Parent Task Title (may not require sub-tasks if purely structural or configuration)
```

## Interaction Model

The process explicitly requires a pause after generating parent tasks to get user confirmation ("Go") before proceeding to generate the detailed TDD sub-tasks. This ensures the high-level plan aligns with user expectations before diving into details.
