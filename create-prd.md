...
4.  **Save PRD:** Save the generated document as `prd-claim-settlement-assistant.md` inside the `/ai-dev-tasks` directory.
...
*   **Filename:** `prd-claim-settlement-assistant.md`
